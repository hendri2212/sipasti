...
class AssetUserTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('asset_user')->insert([
            ...
            ['user_id' => 4, 'asset_id' => 1,  'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 4, 'asset_id' => 2,  'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 4, 'asset_id' => 3,  'created_at' => now(), 'updated_at' => now()],
            ...
            ['user_id' => 9, 'asset_id' => 1,  'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 9, 'asset_id' => 2,  'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 9, 'asset_id' => 3,  'created_at' => now(), 'updated_at' => now()],
