...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/rent/{rentalAsset}/reject', [RentalController::class, 'reject'])->name('rent.reject');
    Route::get('rent/events/{assetId}', [RentalController::class, 'byAssetId'])->name('rent.events');
    ...
    Route::get('/profile/password', [UserController::class, 'edit'])->name('password.edit');
    Route::put('/profile/password', [UserController::class, 'update'])->name('password.update');
});
